            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body row">
                    ...
                    <div class="col-md-6 mb-3 info-individual">
                            ...
                            <input name="birth" type="date" class="form-control" placeholder="" id="txtStudenBirth">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="trainingSystem" class="form-control" id="sel1">
                        ...
                        <div class="form-group">
                            ...
                            <select name="trainingProgram" class="form-control" id="sel1">
                                <option>Chuẩn</option>
                                <option>CLC</option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="yearOfCourse" class="form-control" id="sel1">
    ...
    <div class="col-md-6">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                        ...
                        <input name="city" type="text" class="form-control" placeholder="" id="txtCity">
                        <label for="district">Quận/Huyện</label>
                        <input name="district" type="text" class="form-control" placeholder="" id="txtDistrict">
                        <label for="commune">Xã</label>
                        <input name="commune" type="text" class="form-control" placeholder="" id="txtCommune">
                        <label for="street">Đường</label>
                        <input name="street" type="text" class="form-control" placeholder="" id="txtStreet">
                        <label for="homeNumber">Số nhà</label>
                        <input name="number" type="number" class="form-control" placeholder="" id="txtHomeNumber">
                    </form>
                </div>
            </div>
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                        ...
                        <textarea  name="forte" class="form-control" rows="5" id="txtForte"></textarea>
