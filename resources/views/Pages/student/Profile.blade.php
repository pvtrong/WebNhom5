        ...
        <div class="col-md-6">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <textarea  name="forte" value="{{$student->forte}}" class="form-control ckeditor" rows="5" id="txtForte"><?php echo $student->forte?></textarea>

                    <label for="skill">Năng khiếu</label>
                    <textarea name="skill"  value="{{$student->skill}}" class="form-control ckeditor" rows="5" id="txtSkill"><?php echo $student->skill?></textarea>

                    <label for="favourite">Sở thích</label>
                    <textarea name="favourite" value="{{$student->favourite}}" class="form-control ckeditor" rows="5" id="txtFavorite"><?php echo $student->favourite?></textarea>
